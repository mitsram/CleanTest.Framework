...
/// <summary>
/// Represents an adapter for Playwright's ILocator, implementing the IWebElementAdapter interface.
/// </summary>
public class PlaywrightWebElementAdapter : IWebElementAdapter
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PlaywrightWebElementAdapter"/> class.
    /// </summary>
    /// <param name="element">The ILocator instance to be used by the adapter.</param>
